...
\begin{dialogue}
	...
	\speak{\#010} \textit{"We are in their den after all, just try to save as much stamina as possible!"}\\
	...
	\speak{Elby} \textit{"Freeze it"}
	\speak{\#010} \textit{"Maybe by combining our skills we can bring it down. Let's try!"}\\
...
\begin{dialogue}
	...
	Entering Safe Room:
	\speak{\#010} \textit{"We should be safe in here, we can make a brief stop to regain strength"}\\
...
\begin{dialogue}
	...
	\speak{Elby} \textit{"Don't distract yourself!"}
...
\begin{dialogue}
	...
	\speak{\#010} \textit{"\#001!"}
	\speak{Kyle} \textit{"Oh, finally. I was starting to think you were dead along the way!"}
	...
	\speak{Elby} \textit{"Friends ... don't ... LIE !!!"} \direct{Gust of energy}
...
\begin{dialogue}
	...
	\speak{Kyle} \textit{"..."}
	The costrinctions around 005 are released, allowing him to move.
	...
	\textbf{Elby uses her powers to open a portal}\\
